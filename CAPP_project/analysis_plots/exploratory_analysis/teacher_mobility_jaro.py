...
def load_school_data():
    """
    Load school, teacher and mobility data which will go as inputs to Jaro-Winkler
    """
...
def get_school_jaro_distance(DataFrame, name):
    """
    Match school names using jaro-winkler probability to obtain school ID
    """
...
print(f"Teacher and mobility files generated in {elapsed_time:.2f}!")