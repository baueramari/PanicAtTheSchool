...
descriptions = {
    ...
    "intro one": """Using CPS attendance data since 2003, we averaged attendance rates for Pre-K, Elementary (grades K-5), Middle (grades 6-8),
                    ...
                    We see, on average, only 76% of high school students are regularly attending school, which leaves almost a quarter of the high school
    ...
    "ISS and OSS": """Continuing with the trend of crime and misconduct, we next investigated the average unique suspension rate within a
            ...
            or because the students in these schools are “criminalized” (or seen as more “in need” of a suspension) that the medium and low crime
